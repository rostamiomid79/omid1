...
class Basket(models.Model):
    ...
    def get_basket(cls, basket_id):
        if basket_id is None:
            ...
            try:
                basket = cls.objects.create(pk=basket_id)
...
class BasketLine(models.Model):
    basket = models.ForeignKey(User, on_delete=models.CASCADE, related_name='lines')
    product = models.ForeignKey(Product, on_delete=models.CASCADE, related_name='lines')
    quantity = models.PossitiveSmallIntegerField(default=1)
